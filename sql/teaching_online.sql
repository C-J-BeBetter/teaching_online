...
create database if not exists `teaching_online`;
use `teaching_online`;
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 1582 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '提交作业信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `l_learning_record_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1582 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学习记录信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1582 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '作业讨论答疑信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1583 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '上传学习资料信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_upload_work_file_info`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1582 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '上传作业信息表' ROW_FORMAT = Dynamic;
